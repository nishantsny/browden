...
def test_touch_resets_age(fake_clock):
    ...
    reg.touch("p")
    clock.t += 5000
    assert reg.idle_tabs(3600) == ["p"]
    reg.touch("p")  # reset
    assert reg.idle_tabs(3600) == []
